...
import '../../provider/update_nutrition_provider.dart';
import '../../provider/user_status_provider.dart';
import '../admin/EditNutritionPage.dart';

class CutNutritionPage extends StatefulWidget {
  const CutNutritionPage({Key? key}) : super(key: key);

  @override
  State<CutNutritionPage> createState() => _CutNutritionPageState();
}

class _CutNutritionPageState extends State<CutNutritionPage> {
  late Future<List<Nutrition>> nutritions;

  @override
  void initState() {
    super.initState();
    nutritions = NutritionService.getNutritionCut();
  }
                    ...
                    child: const Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            '1. Avoid sweet foods/drinks\n2. Avoid Junk Food/fast food\n3. Avoid processed flour foods\n4. Fasting for more than 12 hours',
                            style: TextStyle(
                                color: Colors.black,
                                fontSize: 12,
                                fontWeight: FontWeight.w600),
