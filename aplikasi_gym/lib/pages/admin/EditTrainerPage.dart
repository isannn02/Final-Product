...
class EditTrainerPage extends StatefulWidget {
  final String page;
  const EditTrainerPage({Key? key, required this.page}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        AdminTextField(
                          ...
                          hint: "",
                          isImage: false,
                          controller: trainerProvider.trainerNameControler,
                          validatorText: "Please enter your name",
                          type: ScreenType.editTrainer,
                        ),
                        AdminTextField(
                          label: "Number Phone",
                          hint: "",
                          isImage: false,
                          controller: trainerProvider.numberPhone,
                        ...
                        AdminTextField(
                          ...
                          hint: "",
                          isImage: true,
                          controller: trainerProvider.imageController,
