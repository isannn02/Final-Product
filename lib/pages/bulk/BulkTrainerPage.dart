...
import '../admin/EditTrainerPage.dart';

class BulkTrainerPage extends StatefulWidget {
  const BulkTrainerPage({Key? key}) : super(key: key);

  @override
  State<BulkTrainerPage> createState() => _BulkTrainerPageState();
}

class _BulkTrainerPageState extends State<BulkTrainerPage> {
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          HelperApp.sendWhatsApp(
                                              phoneNumbers: review.phone,
                                              nametrainer: review.name);
                                        },
                                        child: Container(
                                          width: widthContact,
                                          padding: const EdgeInsets.only(
                                  ...
                                  Visibility(
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        context
                                            .read<UpdateTrainerProvider>()
                                            .setinitial(trainer: review);
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) =>
